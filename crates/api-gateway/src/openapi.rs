...
fn p(
    ...
    summary: &str,
    op_id: &str,
) -> (String, utoipa::openapi::PathItem) {
    ...
    insert_all(
        ...
        vec![
            ...
            p(
                ...
                "users",
                "Lightweight profile popover payload",
                "users_popover",
            ),
        ],
    );
...
fn add_post_paths(doc: &mut utoipa::openapi::OpenApi) {
    insert_all(
        ...
        vec![
            ...
            p("GET", "/v1/reels/trending", "posts", "Trending reels (24h)", "reels_trending"),
            p(
                "GET",
                "/v1/reels/explore",
                "posts",
                "Explore reels (newest)",
                "reels_explore",
            ),
            p(
                "GET",
            ...
            p(
                ...
                "posts",
                "Trending reel audio tracks",
                "reels_audio_trending",
            ),
            p(
                "GET",
                "/v1/reels/audio/search",
                "posts",
                "Search reel audio tracks",
                "reels_audio_search",
            ),
            p(
                "POST",
            ...
            p(
                ...
                "posts",
                "List users who reacted (filter by reaction_type)",
                "posts_reactors",
            ),
            p(
                "POST",
            ...
            p(
                ...
                "posts",
                "Mark a product/offer post as sold",
                "posts_sold",
            ),
            p(
                "DELETE",
                "/v1/posts/{id}/images/{image_id}",
                "posts",
            ...
            p(
                ...
                "posts",
                "Fetch URL preview metadata (OG/Twitter)",
                "posts_url_preview",
            ),
            p(
                "GET",
...
fn add_messaging_paths(doc: &mut utoipa::openapi::OpenApi) {
    insert_all(
        ...
        vec![
            ...
            p(
                "PUT",
                "/v1/conversations/{id}/color",
                "messaging",
                "Update conversation color",
                "conv_color",
            ),
            p(
                "POST",
            ...
            p(
                "DELETE",
                "/v1/broadcasts/{id}/members/{user_id}",
                "messaging",
    ...
    insert_all(
        ...
        vec![
            ...
            p(
                ...
                "/v1/media/{id}/crop",
                "media",
                "Crop an image (x/y/width/height px)",
                "media_crop",
            ),
        ],
    );
    ...
    insert_all(
        ...
        vec![
            ...
            p(
                ...
                "/v1/pages/nearby",
                "pages",
                "Nearby pages (Haversine; lat/lng/radius_km/category)",
                "pages_nearby",
            ),
        ],
    );
    ...
    insert_all(
        ...
        vec![
            ...
            p(
                ...
                "/v1/emojis",
                "content",
                "Public emoji catalog grouped by category",
                "emojis_catalog",
            ),
        ],
    );
    ...
    insert_all(
        ...
        vec![
            ...
            p(
                ...
                "/v1/jobs/nearby",
                "commerce",
                "Jobs near the user (lat/lng/radius)",
                "jobs_nearby",
            ),
...
fn add_admin_paths(doc: &mut utoipa::openapi::OpenApi) {
    insert_all(
        ...
        vec![
            ...
            p(
                "GET",
                "/v1/admin/dashboard/top-countries",
                "admin",
                "Top countries",
                "admin_countries",
            ),
            ...
            p(
                "POST",
                "/v1/admin/moderation/posts/{id}/approve",
                "admin",
                "Approve post",
                "admin_mod_approve",
            ),
            p(
                "POST",
                "/v1/admin/moderation/posts/{id}/reject",
                "admin",
                "Reject post",
                "admin_mod_reject",
            ),
            ...
            p(
                "POST",
                "/v1/admin/moderation/blogs/{id}/approve",
                "admin",
                "Approve blog",
                "admin_mod_blog_approve",
            ),
            p(
                "POST",
                "/v1/admin/moderation/blogs/{id}/reject",
                "admin",
                "Reject blog",
                "admin_mod_blog_reject",
            ),
            p(
                "DELETE",
                "/v1/admin/posts/{id}",
            ...
            p(
                "POST",
                "/v1/admin/payments/withdrawals/{id}/approve",
                "admin",
                "Approve withdrawal",
                "admin_pay_wd_approve",
            ),
            p(
                "POST",
                "/v1/admin/payments/withdrawals/{id}/reject",
                "admin",
                "Reject withdrawal",
                "admin_pay_wd_reject",
            ),
            ...
            p(
                "POST",
                "/v1/admin/users/{user_id}/make-admin",
                "admin",
                "Make admin",
                "admin_make_admin",
            ),
            p(
                "POST",
                "/v1/admin/users/{user_id}/remove-admin",
                "admin",
                "Remove admin",
                "admin_rm_admin",
            ),
            p(
                "POST",
                "/v1/admin/users/{user_id}/make-pro",
                "admin",
                "Make pro",
                "admin_make_pro",
            ),
            p(
                "POST",
                "/v1/admin/users/{user_id}/remove-pro",
                "admin",
                "Remove pro",
                "admin_rm_pro",
            ),
            ...
            p(
                "DELETE",
                "/v1/admin/site-groups/{id}",
                "admin",
                "Delete site group",
                "admin_site_group_del",
            ),
            p(
                "GET",
                "/v1/admin/site-blogs",
            ...
            p(
                "POST",
                "/v1/admin/site-blogs/{id}/approve",
                "admin",
                "Approve blog",
                "admin_site_blog_approve",
            ),
            p(
                "DELETE",
                "/v1/admin/site-blogs/{id}",
                "admin",
                "Delete site blog",
                "admin_site_blog_del",
            ),
            ...
            p(
                "DELETE",
                "/v1/admin/site-products/{id}",
                "admin",
                "Delete site product",
                "admin_site_product_del",
            ),
            p(
                "GET",
                "/v1/admin/site-jobs",
            ...
            p(
                "DELETE",
                "/v1/admin/site-funding/{id}",
                "admin",
                "Delete site funding",
                "admin_site_funding_del",
            ),
            p(
                "GET",
                "/v1/admin/site-events",
                "admin",
                "List site events",
                "admin_site_events",
            ),
            p(
                "DELETE",
                "/v1/admin/site-events/{id}",
                "admin",
                "Delete site event",
                "admin_site_event_del",
            ),
            p(
                "GET",
                "/v1/admin/site-forums",
                "admin",
                "List site forums",
                "admin_site_forums",
            ),
            p(
                "PUT",
                "/v1/admin/site-forums/{id}",
                "admin",
                "Update site forum",
                "admin_site_forum_upd",
            ),
            p(
                "DELETE",
                "/v1/admin/site-forums/{id}",
                "admin",
                "Delete site forum",
                "admin_site_forum_del",
            ),
            // Colored Posts
            p(
                "GET",
                "/v1/admin/colored-posts",
                "admin",
                "List colored post templates",
                "admin_colored",
            ),
            p(
                "POST",
                ...
                "admin_colored_create",
            ),
            p(
                "PUT",
                "/v1/admin/colored-posts/{id}",
                "admin",
                "Update colored template",
                "admin_colored_upd",
            ),
            p(
                "DELETE",
                "/v1/admin/colored-posts/{id}",
                "admin",
                "Delete colored template",
                "admin_colored_del",
            ),
            // Reaction Types
            p(
                "GET",
                "/v1/admin/reaction-types",
                "admin",
                "List reaction types",
                "admin_reactions",
            ),
            p(
                ...
                "admin_reaction_create",
            ),
            p(
                "PUT",
                "/v1/admin/reaction-types/{id}",
                "admin",
            ...
            p(
                ...
                "admin",
                "Create sticker pack",
                "admin_sticker_create",
            ),
            p(
                "PUT",
                "/v1/admin/sticker-packs/{id}",
                "admin",
                "Update sticker pack",
                "admin_sticker_upd",
            ),
            ...
            p(
                "GET",
                "/v1/admin/sticker-packs/{pack_id}/stickers",
                "admin",
            ...
            p(
                "DELETE",
                "/v1/admin/stickers/{id}",
                "admin",
                "Delete sticker",
                "admin_sticker_item_del",
            ),
            // Activity Log
            p(
                "GET",
            ...
            p(
                ...
                "/v1/admin/changelog",
                "admin",
                "List applied DB migrations (_sqlx_migrations)",
                "admin_changelog",
            ),
            p(
                "GET",
                "/v1/admin/manage-updates",
                "admin",
                "Current backend/DB/Redis versions + runtime info",
                "admin_updates",
            ),
            // Cronjobs
            p(
                ...
                "/v1/admin/cronjobs",
                "admin",
                "List cronjob configs + last run status",
                "admin_cron_list",
            ),
            p(
                "PUT",
                "/v1/admin/cronjobs/{name}",
                "admin",
            ...
            p(
                "GET",
                "/v1/admin/cronjobs/runs",
                "admin",
                "Recent cronjob execution history",
                "admin_cron_runs",
            ),
            ...
            p(
                ...
                "/v1/admin/live/stats",
                "admin",
                "Live streaming stats (active/total/viewers)",
                "admin_live_stats",
            ),
            // Audit log
            p(
            ...
            p(
                ...
                "admin",
                "Per-user admin permission grid",
                "admin_perms_list",
            ),
            p(
                "PUT",
                "/v1/admin/permissions/{user_id}",
                "admin",
            ...
            p(
                "POST",
                "/v1/admin/oauth-apps/{id}/approve",
                "admin",
                "Approve OAuth app",
                "admin_oauth_approve",
            ),
    ...
    insert_all(
        ...
        vec![
            ...
            p(
                ...
                "/v1/ai/generate-blog",
                "ai",
                "AI — generate a blog article",
                "ai_gen_blog",
            ),
            p(
                "POST",
                "/v1/ai/generate-images",
                "ai",
                "AI — generate images from a prompt",
                "ai_gen_images",
            ),
            p(
                "GET",
                "/v1/ai/balance",
                "ai",
                "Remaining AI credits (words + images)",
                "ai_balance",
            ),
            p(
                "GET",
    ...
    insert_all(
        ...
        vec![
            ...
            p(
                ...
                "/internal/broadcast",
                "realtime",
                "Internal: broadcast to users via WS",
                "internal_broadcast",
            ),
        ],
    );
