...
pub fn create_router(state: AiState) -> Router {
    Router::new()
        ...
        .route("/v1/ai/admin/providers", get(handlers::admin_list_providers).post(handlers::admin_create_provider))
        .route("/v1/ai/admin/providers/health", get(handlers::admin_providers_health))
        .route("/v1/ai/admin/providers/{id}", patch(handlers::admin_update_provider).delete(handlers::admin_delete_provider))
        .route("/v1/ai/admin/providers/{id}/test", post(handlers::admin_test_provider))
        // Health
