...
pub fn create_router(state: AppState) -> Router {
    Router::new()
        // ── Products ──
        .route("/v1/products", get(handlers::products::list_products).post(handlers::products::create_product))
        ...
        .route("/v1/products/{id}", get(handlers::products::get_product).put(handlers::products::update_product).delete(handlers::products::delete_product))
        .route("/v1/products/{id}/reviews", get(handlers::products::list_reviews).post(handlers::products::add_review))
        .route("/v1/products/nearby", post(handlers::products::nearby_products))
        // ── Cart ──
        .route("/v1/cart", get(handlers::cart::list_cart).post(handlers::cart::add_to_cart).delete(handlers::cart::clear_cart))
        .route("/v1/cart/{id}", put(handlers::cart::update_cart_item).delete(handlers::cart::remove_from_cart))
        // ── Orders ──
        ...
        .route("/v1/orders/{id}/invoice", get(handlers::invoices::download_invoice))
        // ── Jobs ──
        .route("/v1/jobs", get(handlers::jobs::list_jobs).post(handlers::jobs::create_job))
        ...
        .route("/v1/jobs/{id}", get(handlers::jobs::get_job).put(handlers::jobs::update_job).delete(handlers::jobs::delete_job))
        ...
        // ── Funding ──
        .route("/v1/fundings", get(handlers::funding::list_fundings).post(handlers::funding::create_funding))
        .route("/v1/fundings/my", get(handlers::funding::my_fundings))
        .route("/v1/fundings/{id}", get(handlers::funding::get_funding).put(handlers::funding::update_funding).delete(handlers::funding::delete_funding))
        ...
        // ── Offers ──
        .route("/v1/offers", get(handlers::offers::list_offers).post(handlers::offers::create_offer))
        .route("/v1/offers/my", get(handlers::offers::my_offers))
        .route("/v1/offers/nearby", get(handlers::offers::nearby_offers))
        .route("/v1/offers/{id}", get(handlers::offers::get_offer).put(handlers::offers::update_offer).delete(handlers::offers::delete_offer))
        // ── Gifts ──
