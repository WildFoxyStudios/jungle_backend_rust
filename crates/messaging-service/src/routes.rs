...
pub fn create_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/v1/conversations/{id}/pin", post(handlers::conversations::pin_conversation))
        .route("/v1/conversations/{id}/pin", delete(handlers::conversations::unpin_conversation))
        .route("/v1/conversations/{id}/archive", post(handlers::conversations::archive_conversation))
        .route("/v1/conversations/{id}/archive", delete(handlers::conversations::unarchive_conversation))
        ...
        // Messages
        .route("/v1/conversations/{id}/messages", get(handlers::messages::list_messages))
        .route("/v1/conversations/{id}/messages", post(handlers::messages::send_message))
        ...
        .route("/v1/messages/{id}/pin", post(handlers::messages::pin_message))
        .route("/v1/messages/{id}/pin", delete(handlers::messages::unpin_message))
        ...
        // Broadcasts
        .route("/v1/broadcasts", get(handlers::broadcasts::list_broadcasts))
        .route("/v1/broadcasts", post(handlers::broadcasts::create_broadcast))
        .route("/v1/broadcasts/{id}", put(handlers::broadcasts::update_broadcast))
        .route("/v1/broadcasts/{id}", delete(handlers::broadcasts::delete_broadcast))
        .route("/v1/broadcasts/{id}/members", get(handlers::broadcasts::list_members))
        .route("/v1/broadcasts/{id}/members", post(handlers::broadcasts::add_members))
        ...
        // Calls
        .route("/v1/calls", get(handlers::calls::list_calls))
        .route("/v1/calls", post(handlers::calls::create_call))
