...
pub fn create_router(state: AppState) -> Router {
    Router::new()
        ...
        .route("/v1/media/{id}", get(handlers::upload::get_media))
        .route("/v1/media/{id}", delete(handlers::upload::delete_media))
        .route("/v1/media/my", get(handlers::upload::my_media))
        // Stories
        .route("/v1/stories", get(handlers::stories::list_stories))
        .route("/v1/stories", post(handlers::stories::create_story))
        .route("/v1/stories/{id}", get(handlers::stories::get_story))
        .route("/v1/stories/{id}", delete(handlers::stories::delete_story))
