...
pub fn create_router(state: AppState) -> Router {
    Router::new()
        // Profile
        .route("/v1/users/me", get(handlers::profile::get_me).put(handlers::profile::update_me).delete(handlers::extras::delete_account))
        ...
        // Social
        .route("/v1/social/follow/{user_id}", post(handlers::social::follow_user).delete(handlers::social::unfollow_user))
        ...
        .route("/v1/social/block/{user_id}", post(handlers::social::block_user).delete(handlers::social::unblock_user))
        // Poke
        .route("/v1/social/pokes", get(handlers::social::list_pokes))
        .route("/v1/social/poke/{user_id}", post(handlers::social::poke_user))
        // Mute
        .route("/v1/social/mute/{user_id}", post(handlers::social::mute_user).delete(handlers::social::unmute_user))
        // Family
        .route("/v1/social/family/{id}", post(handlers::extras::send_family_request).put(handlers::extras::respond_family_request))
        // Stop Notify
        ...
        // LinkedIn Mode
        .route("/v1/users/me/open-to-work", post(handlers::extras::set_open_to_work).delete(handlers::extras::unset_open_to_work))
        .route("/v1/users/me/providing-service", post(handlers::extras::set_providing_service).delete(handlers::extras::unset_providing_service))
        // Nearby
        ...
        .route("/v1/users/me/fields", get(handlers::extras::get_my_field_values).put(handlers::extras::update_my_field_values))
        ...
        // User addresses
        .route("/v1/users/me/addresses", get(handlers::addresses::list_addresses).post(handlers::addresses::create_address))
        .route("/v1/users/me/addresses/{id}", get(handlers::addresses::get_address).put(handlers::addresses::update_address).delete(handlers::addresses::delete_address))
        // Social links
