...
pub async fn list_experience(
    ...
    let rows = sqlx::query_as::<_, (i64, String, String, Option<String>, Option<String>, Option<time::Date>, Option<time::Date>, bool)>(
    ...
    let data: Vec<Value> = rows
        .into_iter()
        .map(|(id, title, company, location, desc, start, end, current)| {
            json!({
                "id": id,
                "title": title,
                "company": company,
...
pub async fn list_certifications(
    ...
    let rows = sqlx::query_as::<_, (i64, String, Option<String>, Option<time::Date>, Option<time::Date>, Option<String>)>(
...
pub async fn list_projects(
    ...
    let rows = sqlx::query_as::<_, (i64, String, Option<String>, Option<String>, Option<time::Date>, Option<time::Date>)>(
